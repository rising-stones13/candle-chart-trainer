        ...
        <div className="flex flex-col items-center justify-center min-h-screen">
          ...
          <div className="mt-8 flex flex-col items-center gap-4">
            <div className="flex gap-4 text-sm text-muted-foreground">
              <Link to="/help" className="hover:text-primary underline underline-offset-4">ヘルプ</Link>
              <Link to="/terms" className="hover:text-primary underline underline-offset-4">利用規約</Link>
              <Link to="/privacy" className="hover:text-primary underline underline-offset-4">プライバシーポリシー</Link>
              <Link to="/legal" className="hover:text-primary underline underline-offset-4">特定商取引法に基づく表記</Link>
            </div>
